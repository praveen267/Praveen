...
class App extends Component {
  ...
  return (
	...
	<form style={{backgroundColor:'#DEDEDE',color:'red',fontSize:'20px',width:'100%',textAlign:'center',display:'flex',marginLeft:'500px'}} >
	ByMoney: 
	...
	<input type="submit" value="Refreas" onSubmit={this.onSubmits}/>
